...
The true utility of the simulator is that a number of aspects of ISR processing can be explored. This simulator can be used to determine optimal experiment set ups, to perform trade offs between statistical certainty and space-time resolution. 

Large statistical studies can also be done to determine raw statistics coming out of different types of fitting methods. One set of experiments used 
