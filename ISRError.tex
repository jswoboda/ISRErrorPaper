...
% JOHN:  I may have missed something, but what are you using to fit the data (i.e., for the nonlinear minimization)?    You refer to Lev-Mar as something used "in the past."  
