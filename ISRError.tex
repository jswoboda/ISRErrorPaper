...
To show the impact of the ambiguity function and statistical errors on the measurement the ISR simulator is run with a realistic example. Using the output of a multifluid model \citep{semeter:plasmatransport2012}. The specific example used comes from \cite{Perry:2015jf}.
