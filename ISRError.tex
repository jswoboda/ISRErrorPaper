...
\begin{figure}[!t]
\centering
\includegraphics[width=5in]{056_inputdata}
\caption{Perturbations to Figure \ref{fig:plparamst0} due to an imposed current system of .875 $\mu$A/m$^2$ at $t=840$ s.}
...
The output of the ISR simulator from the parameters can be see in Figure  \ref{fig:fplparamst60}. This simulation shows a 60 second integration time, which for the 27 beam experiment set up gives 255 pulses per position. The depletion in electron density can still be observed in some of the figures.
...
\caption{Fitted Plasma Parameters at $t=840$ s with 240 second integration.}
\label{fig:f240plparamst60}
\end{figure}


%% Fitted Data 15 second int
\begin{figure}[!t]
\centering
\includegraphics[width=5in]{0480_15_int}
\caption{Fitted Plasma Parameters at $t=840$ s with 15 second integration.}
