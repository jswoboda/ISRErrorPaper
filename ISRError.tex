...
% JOHN:  the use of a summation rule is intimately connected to the "overspread" issue, which leads to redundant entries in the lag profile matrix, right?   I wonder if we can say something insightful about this here.  As far as I know, summation rule issues haven't been discussed in the literature in detail.
