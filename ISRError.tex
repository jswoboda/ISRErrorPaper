...
\begin{figure}[!t]
\centering
\includegraphics[width=5in]{1740_240_int}
\caption{Fitted Plasma Parameters at $t=19740$ s with 240 second integration.}
\label{fig:fplparamst120}
\end{figure}
...
\centering
\includegraphics[width=5in]{029_fitteddata_keep}
\caption{Fitted Plasma Parameters at $t=19740$ swith 15 second integration}
\label{fig:fplparamst120}
\end{figure}
