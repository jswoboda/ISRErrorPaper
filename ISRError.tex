...
The true utility of the simulator is that a number of aspects of ISR processing can be explored. This will be shown in the upcoming examples. The first example will show how the simulator can be used for larger statistical studies. Lastly, using the output of a fully consistent multi-fluid ionosphere model we drive the ISR simulator to show how one can plan possible experiments.
...
\begin{figure}[!t]
\centering
\includegraphics[width=5in]{000_inputdata_keep}
...
\begin{figure}[!t]
\centering
\includegraphics[width=5in]{060_inputdata_keep}
...
\begin{figure}[!t]
\centering
\includegraphics[width=5in]{120_inputdata_keep}
